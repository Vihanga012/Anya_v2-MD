...
global.ownername = process.env.Owner_Name || "VIHANGA" 
global.ownernumber = process.env.Owner_Number || "94742377920" 
...
global.mongoUrl = process.env.MongoDB || "mongodb+srv://DARKSHAN:1000@cluster0.t1wsjlv.mongodb.net/"; 
...
module.exports = {
  ...
  ownername: process.env.Owner_Name || "VIHANGA",
  ownernumber: process.env.Owner_Number || "94742377920",
  adress: process.env.Continent || "Asia, sri lanka, monaragala",
  timezone: process.env.TimeZone || "Asia/colombo", 
  instagramId: process.env.Insta || "8.08_only_mine",
  email: process.env.Email_Id || "example@example.com",
  warns: process.env.Warns_Limits || 3,
  mongoUrl: process.env.MongoDB || "mongodb+srv://DARKSHAN:1000@cluster0.t1wsjlv.mongodb.net/",
